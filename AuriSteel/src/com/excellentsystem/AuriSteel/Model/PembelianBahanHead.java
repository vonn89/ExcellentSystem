 ...
 * @author Xtreme
 */
public class PembelianBahanHead {
    ...
    private List<PembelianBahanDetail> listPembelianBahanDetail;
    private List<BebanPembelian> listBebanPembelian;

    public List<PembelianBahanDetail> getListPembelianBahanDetail() {
        return listPembelianBahanDetail;
    }

    public void setListPembelianBahanDetail(List<PembelianBahanDetail> listPembelianBahanDetail) {
        this.listPembelianBahanDetail = listPembelianBahanDetail;
    }
