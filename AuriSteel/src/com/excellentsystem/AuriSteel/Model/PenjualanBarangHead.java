 ...
 * @author Xtreme
 */
public class PenjualanBarangHead {
    ...
    public PemesananBarangHead getPemesananBarangHead() {
        return pemesananBarangHead;
    }

    public void setPemesananBarangHead(PemesananBarangHead pemesananBarangHead) {
        this.pemesananBarangHead = pemesananBarangHead;
    }
    
    public List<PenjualanBarangDetail> getListPenjualanBarangDetail() {
        return listPenjualanBarangDetail;
    }

    public void setListPenjualanBarangDetail(List<PenjualanBarangDetail> listPenjualanBarangDetail) {
        this.listPenjualanBarangDetail = listPenjualanBarangDetail;
    }
