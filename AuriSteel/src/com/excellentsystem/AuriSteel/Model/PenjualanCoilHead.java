 ...
 * @author Xtreme
 */
public class PenjualanCoilHead {
    ...
    private List<PenjualanCoilDetail> listPenjualanDetail;
    ...
    public List<PenjualanCoilDetail> getListPenjualanDetail() {
        return listPenjualanDetail;
    }

    public void setListPenjualanDetail(List<PenjualanCoilDetail> listPenjualanDetail) {
