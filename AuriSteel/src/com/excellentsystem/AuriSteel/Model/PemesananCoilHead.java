 ...
 * @author Xtreme
 */
public class PemesananCoilHead {
    ...
    private List<PemesananCoilDetail> listPemesananCoilDetail;
    ...
    public List<PemesananCoilDetail> getListPemesananCoilDetail() {
        return listPemesananCoilDetail;
    }

    public void setListPemesananCoilDetail(List<PemesananCoilDetail> listPemesananCoilDetail) {
        this.listPemesananCoilDetail = listPemesananCoilDetail;
    }
