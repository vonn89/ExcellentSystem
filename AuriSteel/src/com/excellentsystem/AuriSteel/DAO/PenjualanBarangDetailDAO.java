 ...
 * @author Xtreme
 */
public class PenjualanBarangDetailDAO {
    public static List<PenjualanBarangDetail> getAllByDateAndStatus(
        ...
        List<PenjualanBarangDetail> allDetail = new ArrayList<>();
        ps.setString(1, tglMulai);
        ps.setString(2, tglAkhir);
        ResultSet rs = ps.executeQuery();
        while(rs.next()){
            PenjualanBarangDetail d = new PenjualanBarangDetail();
    ...
    public static List<PenjualanBarangDetail> getAllByTglKirimAndStatus(
            Connection con, String tglMulai, String tglAkhir, String status)throws Exception{
        String sql = "select * from tt_penjualan_detail "
            + " where no_penjualan in (select no_penjualan from tt_penjualan_head "
    ...
    public static List<PenjualanBarangDetail> getAllPenjualanDetail(Connection con, String noPenjualan)throws Exception{
    ...
    public static void insert(Connection con, PenjualanBarangDetail d)throws Exception{
    ...
    public static void update(Connection con, PenjualanBarangDetail d)throws Exception{
