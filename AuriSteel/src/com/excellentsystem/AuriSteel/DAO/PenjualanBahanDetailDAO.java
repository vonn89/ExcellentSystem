 ...
 * @author Xtreme
 */
public class PenjualanBahanDetailDAO {
    public static List<PenjualanBahanDetail> getAllByDateAndStatus(
        ...
        List<PenjualanBahanDetail> allDetail = new ArrayList<>();
        ResultSet rs = ps.executeQuery();
        while(rs.next()){
            PenjualanBahanDetail d = new PenjualanBahanDetail();
    ...
    public static List<PenjualanBahanDetail> getAllPenjualanCoilDetail(Connection con, String noPenjualan)throws Exception{
    ...
    public static void insert(Connection con, PenjualanBahanDetail d)throws Exception{
