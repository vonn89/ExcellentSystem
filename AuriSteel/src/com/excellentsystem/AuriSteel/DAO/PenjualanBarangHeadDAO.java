 ...
 * @author Xtreme
 */
public class PenjualanBarangHeadDAO {
    public static List<PenjualanBarangHead> getAllByNoPemesananAndStatus(Connection con, String noPemesanan, String status)throws Exception{
        ...
        List<PenjualanBarangHead> allPenjualan = new ArrayList<>();
        ResultSet rs = ps.executeQuery();
        while(rs.next()){
            PenjualanBarangHead p = new PenjualanBarangHead();
    ...
    public static List<PenjualanBarangHead> getAllByDateAndStatus(Connection con, String tglMulai,String tglAkhir, String status)throws Exception{
    ...
    public static List<PenjualanBarangHead> getAllByTglKirimAndStatus(Connection con, String tglMulai,String tglAkhir, String status)throws Exception{
    ...
    public static PenjualanBarangHead get(Connection con, String noPenjualan)throws Exception{
        PreparedStatement ps = con.prepareStatement("select * from tt_penjualan_head where no_penjualan = ?");
        ps.setString(1, noPenjualan);
        ResultSet rs = ps.executeQuery();
        PenjualanBarangHead p = null;
        while(rs.next()){
            p = new PenjualanBarangHead();
            p.setNoPenjualan(rs.getString(1));
            p.setTglPenjualan(rs.getDate(2).toString()+" "+rs.getTime(2).toString());
            p.setNoPemesanan(rs.getString(3));
            p.setKodeCustomer(rs.getString(4));
    ...
    public static void insert(Connection con, PenjualanBarangHead p)throws Exception{
    ...
    public static void update(Connection con, PenjualanBarangHead p)throws Exception{
