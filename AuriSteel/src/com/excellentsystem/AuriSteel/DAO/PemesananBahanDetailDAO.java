 ...
 * @author Xtreme
 */
public class PemesananBahanDetailDAO {
    public static List<PemesananBahanDetail> getAllByDateAndStatus(
        ...
        List<PemesananBahanDetail> allDetail = new ArrayList<>();
        while(rs.next()){
            PemesananBahanDetail d = new PemesananBahanDetail();
    ...
    public static List<PemesananBahanDetail> getAllByNoPemesanan(Connection con, String noPemesanan)throws Exception{
    ...
    public static void insert(Connection con, PemesananBahanDetail d)throws Exception{
