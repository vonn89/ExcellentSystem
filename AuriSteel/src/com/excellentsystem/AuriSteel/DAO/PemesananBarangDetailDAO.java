 ...
 * @author Xtreme
 */
public class PemesananBarangDetailDAO {
    public static List<PemesananBarangDetail> getAllByDateAndStatus(Connection con, 
        ...
        List<PemesananBarangDetail> allDetail = new ArrayList<>();
        while(rs.next()){
    ...
    public static List<PemesananBarangDetail> getAllByNoPemesanan(Connection con, String noPemesanan)throws Exception{
    ...
    public static PemesananBarangDetail get(Connection con, String noPemesanan, int noUrut)throws Exception{
    ...
    public static void insert(Connection con, PemesananBarangDetail d)throws Exception{
    ...
    public static void update(Connection con, PemesananBarangDetail d)throws Exception{
