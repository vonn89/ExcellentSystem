...
public class DetailBebanPenjualanController  {
    ...
    @FXML private TableView<BebanPenjualanDetail> bebanPenjualanTable;
    @FXML private TableColumn<BebanPenjualanDetail, String> noBebanColumn;
    @FXML private TableColumn<BebanPenjualanDetail, String> tglBebanColumn;
    @FXML private TableColumn<BebanPenjualanDetail, String> keteranganColumn;
    @FXML private TableColumn<BebanPenjualanDetail, Number> jumlahRpColumn;
