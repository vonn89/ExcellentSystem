...
public class LaporanPembayaranKekuranganController {
    ...
    private void getBarang(){
        try(Connection conCabang = KoneksiCabang.getConnection(cabang)){
            ...
            for(PembayaranPenjualan d : listPembayaran){
                if(!d.getNoPembayaran().substring(3, 9).equals(d.getNoPenjualan().substring(7, 13))){
            ...
            JasperDesign jasperDesign = JRXmlLoader.load(getClass().getResourceAsStream("LaporanPembayaranKekurangan.jrxml"));
