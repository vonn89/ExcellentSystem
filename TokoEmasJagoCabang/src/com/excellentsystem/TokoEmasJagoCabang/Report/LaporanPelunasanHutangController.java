...
public class LaporanPelunasanHutangController {
    ...
    public void initialize(){
        ...
        statusBatal.add("Lunas");
        statusBatal.add("Batal Lunas");
        statusBatalCombo.setItems(statusBatal);
        statusBatalCombo.getSelectionModel().select("Lunas");
    ...
    private void getBarang(){
        try(Connection conCabang = KoneksiCabang.getConnection(cabang)){
            ...
            if(statusBatalCombo.getSelectionModel().getSelectedItem().equals("Lunas")){
                listHutang = HutangHeadDAO.getAllByTglLunas(
                    conCabang, tglAwalPicker.getValue().toString(), tglAkhirPicker.getValue().toString());
            }else if(statusBatalCombo.getSelectionModel().getSelectedItem().equals("Batal Lunas")){
                List<BatalLunas> listBatalLunas = BatalLunasDAO.getAllByDate(
                    conCabang, tglAwalPicker.getValue().toString(), tglAkhirPicker.getValue().toString());
                for(BatalLunas b : listBatalLunas){
                    HutangHead h  = HutangHeadDAO.get(conCabang, b.getNoHutang());
                    listHutang.add(h);
                }
            }
            ...
            JasperDesign jasperDesign = JRXmlLoader.load(getClass().getResourceAsStream("LaporanPelunasanHutang.jrxml"));
