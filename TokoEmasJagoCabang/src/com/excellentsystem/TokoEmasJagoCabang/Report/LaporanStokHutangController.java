...
public class LaporanStokHutangController {
    ...
    public void initialize(){
        ...
        tglPicker.setDayCellFactory((final DatePicker datePicker) -> 
                Function.getDateCellMulai(tglPicker, LocalDate.parse(sistem.getTglSystem())));
    ...
    private void getBarang(){
        try(Connection conCabang = KoneksiCabang.getConnection(cabang)){
            List<StokHutang> listHutang = StokHutangDAO.getAllByTanggal(conCabang, tglPicker.getValue().toString());
