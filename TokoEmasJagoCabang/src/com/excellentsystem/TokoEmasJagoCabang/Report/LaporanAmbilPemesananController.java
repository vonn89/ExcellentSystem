...
public class LaporanAmbilPemesananController {
    ...
    private void getBarang(){
        try(Connection conCabang = KoneksiCabang.getConnection(cabang)){
            List<PemesananDetail> listPemesananDetail = PemesananDetailDAO.getAllByTglAmbil(
            ...
            JasperDesign jasperDesign = JRXmlLoader.load(getClass().getResourceAsStream("LaporanAmbilPemesanan.jrxml"));
