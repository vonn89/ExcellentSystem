...
public class Jenis {
    ...
    private final StringProperty verifikasi = new SimpleStringProperty();
    ...
    public void setVerifikasi(String value) {
        verifikasi.set(value);
    }

    public StringProperty verifikasiProperty() {
        return verifikasi;
    }
