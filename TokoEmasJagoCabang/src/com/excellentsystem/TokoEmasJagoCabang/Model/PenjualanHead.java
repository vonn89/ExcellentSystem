...
public class PenjualanHead {
    ...
    private List<PembayaranPenjualan> listPembayaran;
    ...
    public List<PembayaranPenjualan> getListPembayaran() {
        return listPembayaran;
    }

    public void setListPembayaran(List<PembayaranPenjualan> listPembayaran) {
