...
import Model.BebanPenjualanHead;
...
public class BebanPenjualanHeadDAO {
    ...
    public static String getId(Connection con)throws Exception{
        ...
        ResultSet rs = ps.executeQuery();
        if(rs.next())
            return "BJ-"+yymm.format(serverDate)+new DecimalFormat("000").format(rs.getInt(1)+1);
        else
            return "BJ-"+yymm.format(serverDate)+new DecimalFormat("000").format(1);
    }
