...
import DAO.LogBarangDAO;
import DAO.PenjualanDetailDAO;
import DAO.PenjualanHeadDAO;
import Model.Barang;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try (Connection con = Koneksi.getConnection()) {
            ...
            for (PenjualanHead p : listPenjualan) {
                ...
                keu.setNoKeuangan(KeuanganDAO.getIdByDate(con, date));
                ...
                keu2.setNoKeuangan(KeuanganDAO.getIdByDate(con, date));
    ...
    private void recreateLogBahanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recreateLogBahanActionPerformed
        try (Connection con = Koneksi.getConnection()) {
            ...
            while (rs.next()) {
                ...
                k.setNoKeuangan(KeuanganDAO.getIdByDate(con, tglProduksi));
                ...
                k2.setNoKeuangan(KeuanganDAO.getIdByDate(con, tglBatal));
