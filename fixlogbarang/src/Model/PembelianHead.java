...
public class PembelianHead {
    ...
    private List<PembelianDetail> listPembelianCoilDetail;
    private List<BebanPembelian> listBebanPembelianCoil;
    ...
    public List<PembelianDetail> getListPembelianCoilDetail() {
        return listPembelianCoilDetail;
    }

    public void setListPembelianCoilDetail(List<PembelianDetail> listPembelianCoilDetail) {
        this.listPembelianCoilDetail = listPembelianCoilDetail;
    }

    public List<BebanPembelian> getListBebanPembelianCoil() {
        return listBebanPembelianCoil;
    }

    public void setListBebanPembelianCoil(List<BebanPembelian> listBebanPembelianCoil) {
        this.listBebanPembelianCoil = listBebanPembelianCoil;
    }
