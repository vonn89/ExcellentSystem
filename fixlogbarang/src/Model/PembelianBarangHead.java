 ...
 * @author ASUS
 */
public class PembelianBarangHead {
    ...
    private List<PembelianBarangDetail> listPembelianBarangDetail;
    ...
    public List<PembelianBarangDetail> getListPembelianBarangDetail() {
        return listPembelianBarangDetail;
    }

    public void setListPembelianBarangDetail(List<PembelianBarangDetail> listPembelianBarangDetail) {
        this.listPembelianBarangDetail = listPembelianBarangDetail;
    }
