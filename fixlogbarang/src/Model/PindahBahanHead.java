...
public class PindahBahanHead {
    ...
    private List<PindahBahanDetail> listPindahBahanDetail;

    public List<PindahBahanDetail> getListPindahBahanDetail() {
        return listPindahBahanDetail;
    }

    public void setListPindahBahanDetail(List<PindahBahanDetail> listPindahBahanDetail) {
        this.listPindahBahanDetail = listPindahBahanDetail;
    }
