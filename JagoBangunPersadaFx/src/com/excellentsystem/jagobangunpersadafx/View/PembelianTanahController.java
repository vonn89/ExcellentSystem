...
public class PembelianTanahController {
    @FXML private TableView<PembelianTanah> pembelianTanahTable;
    @FXML private TableColumn<PembelianTanah, String> noPembelianColumn;
    @FXML private TableColumn<PembelianTanah, String> tglPembelianColumn;
    @FXML private TableColumn<PembelianTanah, String> kodePropertyColumn;
    @FXML private TableColumn<PembelianTanah, String> namaPropertyColumn;
    @FXML private TableColumn<PembelianTanah, String> alamatColumn;
    @FXML private TableColumn<PembelianTanah, String> keteranganColumn;
    @FXML private TableColumn<PembelianTanah, Number> luasTanahColumn;
    @FXML private TableColumn<PembelianTanah, Number> hargaBeliColumn;
    @FXML private TableColumn<PembelianTanah, Number> hargaBeliPerMeterColumn;
    @FXML private TableColumn<PembelianTanah, String> statusColumn;
    @FXML private TableColumn<PembelianTanah, String> kodeUserColumn;
    @FXML private TextField searchField;
    @FXML private Label totalPembelian;
