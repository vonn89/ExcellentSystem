...
public class DetailAnggaranController  {
    ...
    @FXML private TreeTableView<RAPDetail> anggaranDetailTable;
    @FXML private TreeTableColumn<RAPDetail, String> pekerjaanColumn;
    @FXML private TreeTableColumn<RAPDetail, String> keteranganColumn;
    @FXML private TreeTableColumn<RAPDetail, String> satuanColumn;
    @FXML private TreeTableColumn<RAPDetail, Number> volumeColumn;
    @FXML private TreeTableColumn<RAPDetail, Number> hargaSatuanColumn;
    @FXML private TreeTableColumn<RAPDetail, Number> totalColumn;
