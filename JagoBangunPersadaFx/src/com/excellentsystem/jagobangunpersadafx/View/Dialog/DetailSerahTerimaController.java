...
public class DetailSerahTerimaController {
    ...
    @FXML private TextField noSerahTerimaField;
    @FXML private TextField tglSerahTerimaField;
    ...
    @FXML public TextField noHGBField;
    @FXML public TextField noIMBField;
    @FXML public TextArea kelengkapanField;
    @FXML public TextArea bonusField;
    
    @FXML private TextField totalDPField;
    @FXML private TextField totalKPRField;
