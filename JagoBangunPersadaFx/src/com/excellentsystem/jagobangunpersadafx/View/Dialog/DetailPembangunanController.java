...
public class DetailPembangunanController  {
    @FXML private TableView<PembangunanDetail> propertyTable;
    @FXML private TableColumn<PembangunanDetail,Boolean> checkColumn;
    @FXML private TableColumn<PembangunanDetail, String> namaPropertyColumn;
    @FXML private TableColumn<PembangunanDetail, Number> luasTanahColumn;
    @FXML private TableColumn<PembangunanDetail, Number> biayaColumn;
    ...
    @FXML private TextField totalBiayaField;
    ...
    @FXML public Label totalBiayaAkhirLabel;
