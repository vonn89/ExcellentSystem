...
public class PelunasanDownPaymentController  {
    ...
    @FXML private TableView<SKLHead> SKLHeadTable;
    @FXML private TableColumn<SKLHead, String> noSKLHeadColumn;
    @FXML private TableColumn<SKLHead, String> tglSKLHeadColumn;
    @FXML private TableColumn<SKLHead, Number> totalPembayaranColumn;
    @FXML private TableColumn<SKLHead, Number> sisaPelunasanColumn;
    @FXML private TableColumn<SKLHead, String> kodeKategoriColumn;
    @FXML private TableColumn<SKLHead, String> namaPropertyColumn;
    @FXML private TableColumn<SKLHead, Number> hargaJualColumn;
    @FXML private TableColumn<SKLHead, Number> diskonColumn;
    @FXML private TableColumn<SKLHead, String> namaCustomerColumn;
    @FXML private TableColumn<SKLHead, String> namaSalesColumn;
    ...
    public void initialize() {
        ...
        sisaPelunasanColumn.setCellValueFactory(cellData ->cellData.getValue().sisaPelunasanProperty());
        sisaPelunasanColumn.setCellFactory(col -> getTableCell(rp));
        ...
        for (SKLHead temp : allSKLHead) {
            if (searchField.getText() == null || searchField.getText().equals(""))
                ...
                if(checkColumn(temp.getNoSKL())||
                    ...
                    checkColumn(rp.format(temp.getSisaPelunasan()))||
