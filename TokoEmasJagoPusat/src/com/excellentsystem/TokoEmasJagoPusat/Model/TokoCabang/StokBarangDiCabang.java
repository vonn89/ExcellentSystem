 ...
 * @author excellent
 */
public class StokBarangDiCabang {
    ...
    private List<StokBarangDiCabang> listStokBarang;

    public List<StokBarangDiCabang> getListStokBarang() {
        return listStokBarang;
    }

    public void setListStokBarang(List<StokBarangDiCabang> listStokBarang) {
        this.listStokBarang = listStokBarang;
    }
