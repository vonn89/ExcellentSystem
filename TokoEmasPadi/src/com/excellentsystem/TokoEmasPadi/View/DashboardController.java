...
public class DashboardController {
    ...
    @FXML private Label totalTerimaGadaiLabel;
    @FXML private Label totalPelunasanGadaiLabel;
    @FXML private Label totalBungaGadaiLabel;
    ...
    private void setOmzetPenjualan(List<Keuangan> listKeuangan) throws Exception {
        ...
        for(String s : periodeOmzetAxis.getCategories()){
            ...
            if(totalPenjualan!=0)
                series1.getData().add(new XYChart.Data<>(s, abs(totalPenjualan)));
        }
        ...
        for(String s : periodeOmzetAxis.getCategories()){
            ...
            if(totalPelunasanGadai!=0)
                series4.getData().add(new XYChart.Data<>(s, abs(totalPelunasanGadai)));
        }
        ...
        for(String s : periodeOmzetAxis.getCategories()){
            ...
            if(totalBungaGadai!=0)
                series5.getData().add(new XYChart.Data<>(s, abs(totalBungaGadai)));
        }
