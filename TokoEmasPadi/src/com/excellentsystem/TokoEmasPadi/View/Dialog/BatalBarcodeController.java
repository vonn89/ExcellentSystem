 ...
 * @author Yunaz
 */
public class BatalBarcodeController  {

    @FXML private TableView<BatalBarcode> barangTable;
    ...
    @FXML private TableColumn<BatalBarcode, Number> qtyColumn;
    ...
    private Stage stage;
    public ObservableList<BatalBarcode> allBarang = FXCollections.observableArrayList();
    ...
    public void setBarang(List<BatalBarcode> x){
        allBarang.addAll(x);
        hitungTotal();
    }
    private void ubahQty(BatalBarcode d){
