...
import com.excellentsystem.PasarBaja.Model.Helper.BestSellingItems;
import com.excellentsystem.PasarBaja.Model.Helper.DashboardModel;
import com.excellentsystem.PasarBaja.Model.Helper.PendingItems;
import com.excellentsystem.PasarBaja.Model.Helper.TopCustomer;
...
public class DashboardController {
    ...
    private void getData(){
        ...
        task.setOnSucceeded((WorkerStateEvent e) -> {
            try{
                ...
                setSalesPerformance(dashboard.getListPenjualanHead());
                setTopCustomer(dashboard.getListPenjualanHead(), dashboard.getListTopCustomer());
    ...
    private void setTopCustomer(List<PenjualanHead> listPenjualan, List<TopCustomer> listCustomer)throws Exception{
        customer.clear();
        double grandtotal = 0;
    ...
    private void setSalesPerformance(List<PenjualanHead> listPenjualan) throws Exception{
