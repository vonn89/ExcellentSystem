...
import com.excellentsystem.PasarBaja.DAO.PembelianBarangDetailDAO;
...
public class Service {
    ...
    public static String deleteBarang(Connection con, Barang barang) {
        try {
            ...
            double stokAkhir = 0;
            LogBarang log = LogBarangDAO.getLastByBarangAndGudang(con, barang.getKodeBarang(), "%");
    ...
    public static String newPembayaranHutang(Connection con, Pembayaran pembayaran) {
        try {
            ...
            if (pembayaran.getHutang().getKategori().equals("Hutang Pembelian")) {
                if (hutang.getKeterangan().startsWith("PB")) {
